export default function Contact() {
    return (
        <section className="bg-gray-900 pt-[3rem]">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-white">
                    Contáctame
                </h2>
                <p className="mb-8 lg:mb-16 font-light text-center text-gray-400 sm:text-xl">
                    ¡Hazme saber cómo puedo ayudarte! Completa el formulario de
                    contacto y estaré encantado de responder a tus preguntas,
                    discutir colaboraciones o simplemente charlar sobre tus
                    ideas.
                </p>
                <form
