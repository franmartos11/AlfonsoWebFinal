    ...
    <section className="w-full px-8 pt-[10rem] pb-[18rem] grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto animate-fade-up animate-once animate-duration-[1700ms]">
      <div>
        ...
        <p><br/></p>
                    ...
                    <Link
                        href="/contact"
                        className="mt-4 inline-block rounded bg-blue-950 px-[4rem] py-2 text-sm font-medium text-white transition hover:bg-blue-900 focus:outline-none focus:ring focus:ring-blue-400"
                    >
                        Contactame
                    </Link>
