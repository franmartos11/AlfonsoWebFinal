                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
                    ...
                    <div className="lg:py-24">
                        ...
                        <p className="mt-4 text-base text-gray-300">
                            Como desarrolladores inmobiliarios especializados en
                            urbanización, nuestro compromiso es crear entornos
                            residenciales que destaquen por su calidad,
                            excelencia y tranquilidad. Cada proyecto que
                            emprendemos se caracteriza por cumplir con los más
                            ...
                            selección estratégica de ubicaciones, nos esforzamos
                            por ofrecer más que simples edificaciones; buscamos
